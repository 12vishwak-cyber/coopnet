...
import { Truck, DollarSign, ClipboardList, BarChart3, ToggleLeft, ToggleRight } from "lucide-react";
        ...
        <div className="bg-card border rounded-lg p-4 animate-fade-up stagger-4 h-fit">
          ...
          <div className="mt-4 pt-4 border-t">
            <p className="text-xs text-muted-foreground">
              <span className="text-primary font-medium">AI Suggestion:</span> You're most efficient in Sector 12 area. Consider prioritizing tasks there.
            </p>
          </div>
        </div>
      </div>
