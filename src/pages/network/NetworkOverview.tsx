...
import { Globe, Users, Truck, PiggyBank, Scale, Database } from "lucide-react";
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
        ...
        <div className="animate-fade-up stagger-4"><StatCard title="Shared Fund" value="₹84,200" change="+₹4,120 this week" changeType="positive" icon={PiggyBank} /></div>
        <div className="animate-fade-up stagger-5"><StatCard title="Active Rules" value="8" change="1 under vote" changeType="neutral" icon={Scale} /></div>
