...
const DRAFT_PRODUCTS: DraftProduct[] = [
  ...
  { id: 'p56', category: 'Bakery', name: 'Fresh Sourdough Loaf', price: 90, originalPrice: 120, unit: '400 g', seller: 'Sweet Crust Bakery', sellerId: 's6', images: sellerImageSets.bakery.sourdough, description: 'Crackly sourdough loaf with open crumb and slight tang.', tag: 'Hot bake' },
  { id: 'p57', category: 'Bakery', name: 'Chocolate Croissant', price: 60, unit: '1 pc', seller: 'Sweet Crust Bakery', sellerId: 's6', images: sellerImageSets.bakery.croissant, description: 'Buttery laminated pastry layered around dark chocolate.' },
  { id: 'p58', category: 'Bakery', name: 'Red Velvet Cake', price: 450, originalPrice: 550, unit: '500 g', seller: 'Sweet Crust Bakery', sellerId: 's6', images: sellerImageSets.bakery.redVelvet, description: 'Moist red velvet sponge with cream cheese frosting.', tag: 'Celebration' },
  { id: 'p59', category: 'Bakery', name: 'Garlic Bread', price: 80, unit: 'Pack of 4', seller: 'Sweet Crust Bakery', sellerId: 's6', images: sellerImageSets.bakery.garlicBread, description: 'Soft bread brushed with roasted garlic butter and herbs.' },
  { id: 'p60', category: 'Bakery', name: 'French Baguette', price: 95, unit: '1 pc', seller: 'Sweet Crust Bakery', sellerId: 's6', images: sellerImageSets.bakery.baguette, description: 'Long crusty baguette with airy crumb and chewy bite.' },
  { id: 'p61', category: 'Bakery', name: 'Cinnamon Roll', price: 85, unit: '1 pc', seller: 'Sweet Crust Bakery', sellerId: 's6', images: sellerImageSets.bakery.cinnamonRoll, description: 'Soft cinnamon roll topped with glossy cream glaze.' },
  { id: 'p62', category: 'Bakery', name: 'Blueberry Muffin', price: 70, unit: '1 pc', seller: 'Sweet Crust Bakery', sellerId: 's6', images: sellerImageSets.bakery.muffin, description: 'Tender bakery muffin packed with blueberries.' },
  { id: 'p63', category: 'Bakery', name: 'Fudge Brownie', price: 95, unit: '2 pcs', seller: 'Sweet Crust Bakery', sellerId: 's6', images: sellerImageSets.bakery.brownie, description: 'Dense, glossy brownie squares with deep cocoa flavour.' },
  { id: 'p64', category: 'Beverages', name: 'Cold Brew Coffee', price: 120, unit: '300 ml', seller: 'Sweet Crust Bakery', sellerId: 's6', images: sellerImageSets.bakery.coffee, description: 'Smooth cold brew made from arabica beans, served chilled.' },

  { id: 'p65', category: 'Pharmacy', name: 'Paracetamol 500mg', price: 25, unit: 'Strip of 10', seller: 'Wellness Pharmacy', sellerId: 's7', images: sellerImageSets.pharmacy.paracetamol, description: 'Fast relief tablets for fever and general body pain.' },
  { id: 'p66', category: 'Pharmacy', name: 'Vitamin C Tablets', price: 180, originalPrice: 220, unit: '60 tabs', seller: 'Wellness Pharmacy', sellerId: 's7', images: sellerImageSets.pharmacy.vitaminC, description: 'Daily immunity support tablets with 1000 mg vitamin C.' },
  { id: 'p67', category: 'Pharmacy', name: 'Hand Sanitizer', price: 65, unit: '200 ml', seller: 'Wellness Pharmacy', sellerId: 's7', images: sellerImageSets.pharmacy.sanitizer, description: 'Quick-drying 70% alcohol sanitizer with aloe.' },
  { id: 'p68', category: 'Pharmacy', name: 'Digital Thermometer', price: 220, originalPrice: 280, unit: '1 unit', seller: 'Wellness Pharmacy', sellerId: 's7', images: sellerImageSets.pharmacy.thermometer, description: 'Fast-read digital thermometer with fever alert beep.' },
  { id: 'p69', category: 'Pharmacy', name: 'Bandage Strips', price: 42, unit: '20 pcs', seller: 'Wellness Pharmacy', sellerId: 's7', images: sellerImageSets.pharmacy.bandages, description: 'Flexible first-aid strips with breathable adhesive.' },
  { id: 'p70', category: 'Pharmacy', name: 'Protein Powder', price: 899, unit: '500 g', seller: 'Wellness Pharmacy', sellerId: 's7', images: sellerImageSets.pharmacy.proteinPowder, description: 'Chocolate whey blend for recovery and daily protein goals.' },
  { id: 'p71', category: 'Pharmacy', name: 'Face Masks', price: 149, unit: '10 pcs', seller: 'Wellness Pharmacy', sellerId: 's7', images: sellerImageSets.pharmacy.faceMasks, description: 'Soft triple-layer masks packed for daily protection.' },
  { id: 'p72', category: 'Pharmacy', name: 'Pain Relief Spray', price: 189, unit: '120 ml', seller: 'Wellness Pharmacy', sellerId: 's7', images: sellerImageSets.pharmacy.painReliefSpray, description: 'Cooling spray for muscle strain, cramps, and stiffness.' },

  { id: 'p73', category: 'Electronics', name: 'Wireless Earbuds', price: 1499, originalPrice: 2499, unit: '1 pair', seller: 'TechHub Electronics', sellerId: 's8', images: sellerImageSets.electronics.earbuds, description: 'Compact earbuds with 24-hour battery and clear voice pickup.', tag: 'Best seller' },
  { id: 'p74', category: 'Electronics', name: 'Fast Charger 25W', price: 599, originalPrice: 899, unit: '1 unit', seller: 'TechHub Electronics', sellerId: 's8', images: sellerImageSets.electronics.charger, description: 'USB-C fast charger with stable thermal control.' },
  { id: 'p75', category: 'Electronics', name: 'Phone Stand', price: 249, unit: '1 unit', seller: 'TechHub Electronics', sellerId: 's8', images: sellerImageSets.electronics.stand, description: 'Adjustable aluminium stand for desks, kitchens, and work calls.' },
  { id: 'p76', category: 'Electronics', name: 'Power Bank 10000mAh', price: 999, originalPrice: 1499, unit: '1 unit', seller: 'TechHub Electronics', sellerId: 's8', images: sellerImageSets.electronics.powerBank, description: 'Slim power bank with 22.5W quick charge output.' },
  { id: 'p77', category: 'Electronics', name: 'Bluetooth Speaker', price: 1299, unit: '1 unit', seller: 'TechHub Electronics', sellerId: 's8', images: sellerImageSets.electronics.bluetoothSpeaker, description: 'Portable speaker with punchy bass and all-day battery.' },
  { id: 'p78', category: 'Electronics', name: 'Smart Watch', price: 1999, originalPrice: 2799, unit: '1 unit', seller: 'TechHub Electronics', sellerId: 's8', images: sellerImageSets.electronics.smartWatch, description: 'Fitness-first watch with AMOLED screen and call support.' },
  { id: 'p79', category: 'Electronics', name: 'Mechanical Keyboard', price: 2499, unit: '1 unit', seller: 'TechHub Electronics', sellerId: 's8', images: sellerImageSets.electronics.keyboard, description: 'Compact keyboard with tactile switches and RGB lighting.' },
  { id: 'p80', category: 'Electronics', name: 'Wireless Mouse', price: 799, unit: '1 unit', seller: 'TechHub Electronics', sellerId: 's8', images: sellerImageSets.electronics.mouse, description: 'Silent click mouse with ergonomic shape and long battery life.' },

  { id: 'p81', category: 'Fashion', name: 'Cotton T-Shirt', price: 399, originalPrice: 599, unit: '1 pc', seller: 'Threads & Trends', sellerId: 's9', images: sellerImageSets.fashion.tshirt, description: 'Breathable heavyweight cotton tee with a clean everyday fit.', tag: 'Trending' },
  { id: 'p82', category: 'Fashion', name: 'Slim Fit Jeans', price: 1299, originalPrice: 1899, unit: '1 pc', seller: 'Threads & Trends', sellerId: 's9', images: sellerImageSets.fashion.jeans, description: 'Stretch denim jeans cut for all-day comfort.' },
  { id: 'p83', category: 'Fashion', name: 'Canvas Sneakers', price: 899, unit: '1 pair', seller: 'Threads & Trends', sellerId: 's9', images: sellerImageSets.fashion.sneakers, description: 'Minimal low-top sneakers with cushioned footbed.' },
  { id: 'p84', category: 'Fashion', name: 'Silk Kurta', price: 1499, originalPrice: 2200, unit: '1 pc', seller: 'Threads & Trends', sellerId: 's9', images: sellerImageSets.fashion.kurta, description: 'Festive silk kurta with subtle woven detailing.' },
  { id: 'p85', category: 'Fashion', name: 'Oversized Hoodie', price: 1299, unit: '1 pc', seller: 'Threads & Trends', sellerId: 's9', images: sellerImageSets.fashion.hoodie, description: 'Brush-back fleece hoodie with a relaxed streetwear fit.' },
  { id: 'p86', category: 'Fashion', name: 'Minimal Tote Bag', price: 699, unit: '1 pc', seller: 'Threads & Trends', sellerId: 's9', images: sellerImageSets.fashion.toteBag, description: 'Structured everyday tote in durable canvas with inside pockets.' },
  { id: 'p87', category: 'Fashion', name: 'Summer Dress', price: 1599, originalPrice: 1999, unit: '1 pc', seller: 'Threads & Trends', sellerId: 's9', images: sellerImageSets.fashion.summerDress, description: 'Flowy midi dress with soft drape and fresh prints.' },
  { id: 'p88', category: 'Fashion', name: 'Polarized Sunglasses', price: 799, unit: '1 pc', seller: 'Threads & Trends', sellerId: 's9', images: sellerImageSets.fashion.sunglasses, description: 'Retro-inspired sunglasses with UV-protected lenses.' },

  { id: 'p89', category: 'Home', name: 'Steel Water Bottle', price: 449, originalPrice: 699, unit: '750 ml', seller: 'Home Essentials Co.', sellerId: 's10', images: sellerImageSets.home.bottle, description: 'Insulated steel bottle that stays cold for long commutes.' },
  { id: 'p90', category: 'Home', name: 'Bedsheet Set', price: 899, originalPrice: 1299, unit: 'Queen size', seller: 'Home Essentials Co.', sellerId: 's10', images: sellerImageSets.home.bedsheet, description: 'Cotton bedsheet set with two soft pillow covers.' },
  { id: 'p91', category: 'Home', name: 'Non-stick Pan', price: 599, unit: '26 cm', seller: 'Home Essentials Co.', sellerId: 's10', images: sellerImageSets.home.pan, description: 'Everyday non-stick pan with even heating and easy cleanup.' },
  { id: 'p92', category: 'Home', name: 'Scented Candle', price: 349, originalPrice: 449, unit: '200 g', seller: 'Home Essentials Co.', sellerId: 's10', images: sellerImageSets.home.candle, description: 'Lavender soy candle that lifts a room without overpowering it.' },
  { id: 'p93', category: 'Home', name: 'Storage Boxes', price: 799, unit: 'Set of 3', seller: 'Home Essentials Co.', sellerId: 's10', images: sellerImageSets.home.storageBox, description: 'Stackable storage boxes for wardrobes and shelf organisation.' },
  { id: 'p94', category: 'Home', name: 'Bedside Lamp', price: 1199, unit: '1 pc', seller: 'Home Essentials Co.', sellerId: 's10', images: sellerImageSets.home.lamp, description: 'Warm bedside lamp with fabric shade and clean silhouette.' },
  { id: 'p95', category: 'Home', name: 'Desk Organiser', price: 499, unit: '1 pc', seller: 'Home Essentials Co.', sellerId: 's10', images: sellerImageSets.home.organiser, description: 'Minimal desk tray for notes, chargers, and small essentials.' },
  { id: 'p96', category: 'Home', name: 'Ceramic Planter', price: 549, unit: '1 pc', seller: 'Home Essentials Co.', sellerId: 's10', images: sellerImageSets.home.planter, description: 'Matte ceramic planter with drainage plate for indoor greens.' },
  { id: 'p97', category: 'Home', name: 'Bath Towels', price: 699, unit: '2 pcs', seller: 'Home Essentials Co.', sellerId: 's10', images: sellerImageSets.home.towels, description: 'Soft absorbent towel set in premium combed cotton.' },
  { id: 'p98', category: 'Home', name: 'Surface Cleaner', price: 199, unit: '500 ml', seller: 'Home Essentials Co.', sellerId: 's10', images: sellerImageSets.home.cleaner, description: 'Fresh fragrance multipurpose cleaner for kitchen and glass.' },

  { id: 'p99', category: 'Personal Care', name: 'Face Wash', price: 199, originalPrice: 249, unit: '100 ml', seller: 'Wellness Pharmacy', sellerId: 's7', images: sellerImageSets.personalCare.faceWash, description: 'Vitamin C face wash with gentle foam and fresh citrus scent.' },
  { id: 'p100', category: 'Personal Care', name: 'Shampoo', price: 299, unit: '340 ml', seller: 'Wellness Pharmacy', sellerId: 's7', images: sellerImageSets.personalCare.shampoo, description: 'Tea-tree shampoo for scalp refresh and daily cleansing.' },
  { id: 'p101', category: 'Personal Care', name: 'Sunscreen SPF 50', price: 499, originalPrice: 649, unit: '50 g', seller: 'Wellness Pharmacy', sellerId: 's7', images: sellerImageSets.personalCare.sunscreen, description: 'Featherlight SPF 50 sunscreen with no white cast.', tag: 'Daily wear' },
  { id: 'p102', category: 'Personal Care', name: 'Body Lotion', price: 349, unit: '250 ml', seller: 'Wellness Pharmacy', sellerId: 's7', images: sellerImageSets.personalCare.lotion, description: 'Shea butter lotion with long-lasting hydration.' },
  { id: 'p103', category: 'Personal Care', name: 'Deodorant Spray', price: 249, unit: '150 ml', seller: 'Wellness Pharmacy', sellerId: 's7', images: sellerImageSets.personalCare.deodorant, description: 'Fresh deodorant spray with all-day odour control.' },
  { id: 'p104', category: 'Personal Care', name: 'Precision Razor', price: 199, unit: '1 unit', seller: 'Wellness Pharmacy', sellerId: 's7', images: sellerImageSets.personalCare.razor, description: 'Close-shave razor with comfort grip and replaceable heads.' },
  { id: 'p105', category: 'Personal Care', name: 'Berry Lip Balm', price: 149, unit: '1 pc', seller: 'Wellness Pharmacy', sellerId: 's7', images: sellerImageSets.personalCare.lipBalm, description: 'Nourishing tinted lip balm with berry fragrance.' },
  { id: 'p106', category: 'Personal Care', name: 'Bamboo Toothbrush', price: 99, unit: '2 pcs', seller: 'Wellness Pharmacy', sellerId: 's7', images: sellerImageSets.personalCare.toothbrush, description: 'Soft-bristle bamboo toothbrush pair with eco packaging.' },
];
